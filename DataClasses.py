...
# Artem Lamnin, 2022-03-26, Added track class code and modified CD class 
#------------------------------------------#
...
class Track():
    ...
    # -- Methods -- #
    # TODone Added Track class methods
    def __str__(self):
...
class CD:
    ...
    """
    # TODone Modified CD class as required
    # -- Constructor -- #
    def __init__(self, cd_id: int, cd_title: str, cd_artist: str,tracks:list) -> None:
    ...
    def add_track(self, track: Track) -> None:
        ...
        """
        #TODone add track code
        self.cd_tracks.append(track)
        # TODOne sort tracks
        self.__sort_tracks()
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        # TODone remove track code
        del self.cd_tracks[track_id-1]
